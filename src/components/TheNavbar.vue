<template>
  <nav class="bg-white dark:bg-gray-900 shadow-sm border-b fixed w-full top-0 z-50 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        <div class="flex items-center">
          ...
          >
            <img
              src="/seward_logo_century_gothic.svg"
              alt="Seward Portfolio Logo"
              class="h-8 w-auto block dark:hidden"
            >
            <img
              src="/srm_logo_century_gothic_white.svg"
              alt="Seward Portfolio Logo (white)"
        ...
        <div class="md:hidden flex items-center">
          <button
            class="p-2 mr-4 rounded-md focus:outline-none"
            aria-label="Toggle dark/light mode"
            @click="toggleTheme"
          >
            <sun-icon
    ...
    <div
      ...
      class="md:hidden bg-white dark:bg-gray-900 border-t dark:border-gray-800 transition-colors"
    >
